...
#' Draw 3D graphs from tradeStats results using rgl
#' 
#' Where more than 2 parameters are searched, there could be duplicate combinations of the paramaters
#' being plotted. In this instance we need to specify an aggregation function for the results from
#' duplicate param combinations. The default will use mean.
#'
...
#' @param fun.aggregate the aggregation function to use for the statistic of interest, passed to reshape2::recast(). See Details.
...
tradeGraphs <- function(stats, free.params, params.filter = NULL, statistics, title = NULL, fun.aggregate=mean)
{
